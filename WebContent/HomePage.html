...
<head profile="http://www.w3.org/2005/10/profile">
	...
	<!-- Google fonts -->
	<link href="https://fonts.googleapis.com/css?family=Sedgwick+Ave+Display|Staatliches|Oswald|Ubuntu&display=swap"
		rel="stylesheet">
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<a class="navbar-brand" href="#"> <i class="fas fa-camera-retro fa-fw silphbar-icon"></i>Silph Inc.
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-file-alt moduli-icon"></i></a>
	...
	<div id="foto-jumbotron" class="jumbotron text-center">
		<div class="container-fluid">
			...
			<p class="lead">
				...
				<br>
				<a href="#" class="link ">Altre foto</a>
			</p>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example1.jpg"
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example2.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example3.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example4.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example5.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example6.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example7.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example8.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg ">
						<div class="hovereffect">
							<a href="#" class="pop"> <img class="card-img" src="SampleData/Pics/example9.jpg"
									data-toggle="modal" data-target="#imagemodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Titolo Foto</h4>
			...
			<div class="row mb-2">
				...
				<div class="col-md-6">
					<div class="card flex-md-row mb-4 shadow-sm h-md-200 albumcell">
						...
						<a href="#"> <img class="card-img-right flex-auto d-none d-lg-block"
								src="SampleData/Pics/example1.jpg"></a>
					</div>
				</div>
				<div class="col-md-6">
					<div class="card flex-md-row mb-4 shadow-sm h-md-200 albumcell">
						<a href="#"> <img class="card-img-left flex-auto d-none d-lg-block"
			...
			<div class="row">
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample1.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample2.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample9.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample3.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample4.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample5.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample6.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample7.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
				...
				<div class="col-md-4 fotocell">
					<div class="card mx-auto shadow-lg fotografo">
						<div class="hovereffect">
							<a class="pop" style="cursor: pointer;"> <img class="card-img" src="SampleData/Pics/fExample8.jpg"
									data-toggle="modal" data-target="#fotografomodal" />
							</a>
							<div class="overlay">
								<h4 class="card-title">Nome Cognome</h4>
	...
	<!-- Modal per i fotografi -->

	<div class="modal fade" id="fotografomodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title fotografo" id="exampleModalLabel">Ciao, sono Nome Cognome 🙂</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					Piccola descrizione fotografo (La bio completa sarà sulla pagina del fotografo)
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary">Biografia</button>
				</div>
			</div>
		</div>
	</div>
