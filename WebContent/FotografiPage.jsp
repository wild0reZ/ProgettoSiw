	...
	<div class="container-fluid mt-4">
		...
		<div class="row justify-content-center">
			...
			<div class="col-auto mb-1">
				<div class="card" style="width: 20rem;">
					<div class="hovereffect">
						<a href="#"><img class="card-img fitSize" src="SampleData/Pics/spacey.jpg"></a>
						<div class="overlay">
			...
			<div class="col-auto mb-3">
				<div class="card" style="width: 20rem;">
					<div class="hovereffect">
						<a href="#"><img class="card-img" src="SampleData/Pics/user-placeholder.png"></a>
						<div class="overlay">
							<h4 class="card-title">Nome Cognome</h4>
						</div>
					</div>
			...
			<div class="col-auto mb-3">
				<div class="card" style="width: 20rem;">
					<div class="hovereffect">
						<a href="#"><img class="card-img" src="SampleData/Pics/image-2.jpg"></a>
						<div class="overlay">
							<h4 class="card-title">Nome Cognome</h4>
						</div>
					</div>
			...
			<div class="col-auto mb-3">
				<div class="card" style="width: 20rem;">
					<div class="hovereffect">
						<a href="#"><img class="card-img" src="SampleData/Pics/pkc.jfif"></a>
						<div class="overlay">
							<h4 class="card-title">Nome Cognome</h4>
						</div>
					</div>
